...
import com.example.ligueprofantasy.controller.PlayerLab;
import com.example.ligueprofantasy.model.AppState;
import com.example.ligueprofantasy.model.Player;
import com.example.ligueprofantasy.model.Team;
import com.example.ligueprofantasy.model.UserData;
...
public class TeamDisplayFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (arguments != null && arguments.getBoolean("teamList")) {
            ...
            view = inflater.inflate(R.layout.fragment_team_display, container, false);
    ...
    private void buildTeam() {
        ...
        System.out.println(playerLab.getPlayer(team.getGoalId())+"AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
    ...
    private void editTeamAtDB(Integer... input) {
        ...
        AsyncTask<Integer, Void, String> asyncTask = new AsyncTask<Integer, Void, String>() {
            ...
            protected void onPostExecute(String message) {
                ...
                registerButton.setText("Save Changes by 10/01/20 23:59");
