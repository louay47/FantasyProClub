...
import static com.example.ligueprofantasy.R.id.players_list_fresher_layout;
import static com.example.ligueprofantasy.R.id.players_list_name_checkbox;
import static com.example.ligueprofantasy.R.id.players_list_name_layout;
...
public class PlayerListFragment extends Fragment {
    ...
    private class PlayerAdapter extends RecyclerView.Adapter<PlayerHolder> {
        ...
        public void onBindViewHolder(PlayerHolder holder, int position) {
            ...
            holder.mPrice.setText("DT" + player.getPrice() + " Mil");
