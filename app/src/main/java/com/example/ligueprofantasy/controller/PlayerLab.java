package com.example.ligueprofantasy.controller;
                   ...
                   // JSONArray players = api.getJSONArray("players");
                    ...
                    for(int i=0; i<array.length(); i++){
                       ...
                       // int sub = object.getInt("out");
                        ...
                        Player player = new Player(id,firstName,lastName,pos,team,10,40,17,appearences,appearences,goal,asist,0,1,owngls,red,yellow,true);
                        ...
                        for (Player p : mPlayers){
                           // System.out.println(p.getTeam());
                            if (p.getTeam() == team_id && p.getLastName().equals(lastName)){
                                int goalPoint = (goal-p.getGoals())*3 ;
                                //System.out.println(goalPoint+"GOALPOINNNNNNNNNNNTS"+p.getLastName());
