package com.example.ligueprofantasy.model;
...
public class Player {
    ...
    public Player(int playerID, String firstName, String lastName, String position, int team, double price, int points, int pointsWeek, int appearances, int subAppearances, int goals, int assists, int cleanSheets, int motms, int ownGoals, int redCards, int yellowCards, boolean isFresher) {
        ...
        switch (team) {
            case 980:  this.image = R.drawable.esperance;
                break;
            case 988:  this.image = R.drawable.ca;
                break;
            case 990:  this.image = R.drawable.ess;
                break;
            case 983:  this.image = R.drawable.css;
                break;
            case 981:  this.image = R.drawable.cab;
                break;
            case 1191:  this.image = R.drawable.hammem_lnf;
                break;
            case 991:  this.image = R.drawable.st;
                break;
            default: this.image = R.drawable.usmo;
                break;
        }
