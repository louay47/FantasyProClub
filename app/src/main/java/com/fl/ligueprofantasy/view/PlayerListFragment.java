...
import static com.fl.ligueprofantasy.R.id.players_list_fresher_layout;
import static com.fl.ligueprofantasy.R.id.players_list_name_checkbox;
import static com.fl.ligueprofantasy.R.id.players_list_name_layout;
...
*/
    ...
    private class PlayerAdapter extends RecyclerView.Adapter<PlayerHolder> {
        ...
        public void onBindViewHolder(PlayerHolder holder, int position) {
            ...
            int goool = playerLab.getPlayer(player.getId()).getGoals();
            holder.mGoals.setText(String.valueOf(goool));
